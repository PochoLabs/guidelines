...
Code reviews are necessary for [quality]({% if site.github.is_project_page %}/guidelines{% endif %}/guidelines/Quality). Each Pull Request should be reviewed by someone. A proper code review can take time, and therefore work best when the PR in question isn't too long.
